...
function loadAssets() {
  ...
  if (!assets.length) {
    // Default: 78 assets 全品类覆盖
    assets = [
      {code:'510300', name:'沪深300ETF'},{code:'512090', name:'MSCI A股ETF'},
      {code:'510500', name:'中证500ETF'},{code:'510050', name:'上证50ETF'},
      {code:'159915', name:'创业板ETF'},{code:'159949', name:'创业板50'},
      {code:'588000', name:'科创50ETF'},{code:'588020', name:'科创成长ETF'},
      {code:'159780', name:'科创创业ETF'},{code:'159967', name:'创业板成长ETF'},
      ...
      {code:'159207', name:'高股息ETF'},{code:'513100', name:'纳指ETF(国泰)'},
      {code:'513500', name:'标普500ETF'},{code:'159920', name:'恒生ETF'},
      {code:'513030', name:'德国30ETF'},{code:'513520', name:'日经ETF'},
      {code:'513080', name:'法国CAC40ETF'},{code:'513050', name:'中概互联'},
      {code:'512880', name:'证券ETF'},{code:'512010', name:'医药ETF'},
      {code:'512660', name:'军工ETF'},{code:'512670', name:'国防ETF'},
      {code:'159638', name:'航空航天ETF'},{code:'159206', name:'卫星ETF'},
      {code:'512480', name:'半导体ETF'},{code:'512690', name:'酒ETF'},
      {code:'515050', name:'5GETF'},{code:'515880', name:'通信ETF'},
      {code:'516510', name:'云计算ETF'},{code:'515400', name:'大数据ETF'},
      {code:'512800', name:'银行ETF'},{code:'512200', name:'房地产ETF'},
      {code:'515700', name:'新能源车ETF'},{code:'515790', name:'光伏ETF'},
      {code:'516160', name:'新能源ETF'},{code:'159996', name:'家电ETF'},
      ...
      {code:'515210', name:'钢铁ETF'},{code:'159819', name:'人工智能ETF'},
      {code:'515980', name:'人工智能ETF华富'},{code:'159530', name:'机器人ETF'},
      {code:'159928', name:'消费ETF'},{code:'159647', name:'中药ETF'},
      {code:'512170', name:'医疗ETF'},{code:'159992', name:'创新药ETF'},
      {code:'159732', name:'消费电子ETF'},{code:'159326', name:'电网设备ETF'},
      {code:'159852', name:'软件ETF'},{code:'516150', name:'稀土ETF'},
      {code:'159755', name:'电池ETF'},{code:'159698', name:'粮食ETF'},
      {code:'159851', name:'金融科技ETF'},{code:'159697', name:'石油ETF'},
      {code:'518880', name:'黄金ETF'},{code:'159562', name:'黄金股ETF'},
      {code:'159980', name:'有色ETF'},{code:'159985', name:'豆粕ETF'},
      {code:'511260', name:'十年国债ETF'},{code:'511360', name:'短融ETF'},
      {code:'511880', name:'银华日利ETF'},{code:'511380', name:'可转债ETF'},
      {code:'511520', name:'政金债ETF'},{code:'508056', name:'普洛斯REIT'},
      {code:'600519', name:'贵州茅台'},{code:'BTC', name:'比特币'},
      {code:'ETH', name:'以太坊'},{code:'TRX', name:'波场'},
    ];
    saveAssets();
  }
}
